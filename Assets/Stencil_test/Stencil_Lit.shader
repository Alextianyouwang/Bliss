Shader "HDRP/LitStencil"
{
    Properties
    {
        ...
        [Enum(UnityEngine.Rendering.CompareFunction)] _Compare("Compare", Int) = 4 // Less equal
        [Enum(UnityEngine.Rendering.StencilOp)] _Pass("Pass", Int) = 4 // Less equal
